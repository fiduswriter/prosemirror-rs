...
function t(str, em = false) { return schema.text(str, em ? [schema.mark("em")] : null); }
const doc = n("doc", // 0
n("head", t("Head")), // 6
n("para", t("Intro")), // 13
n("sect", // 14
...
describe("Transform", () => {
    describe("replace", () => {
        ...
        it("automatically adds a heading to a section", repl(n("doc", n("sect", n("head", t("foo")), n("para", t("bar")))), 6, 6, n("doc", n("sect"), n("sect")), 1, 1, n("doc", n("sect", n("head", t("foo"))), n("sect", n("head"), n("para", t("bar"))))));
        it("suppresses impossible inputs", repl(n("doc", n("para", t("a")), n("para", t("b"))), 3, 3, n("doc", n("closing", t("."))), 0, 0, n("doc", n("para", t("a")), n("para", t("b")))));
        it("adds necessary nodes to the left", repl(n("doc", n("sect", n("head", t("foo")), n("para", t("bar")))), 1, 3, n("doc", n("sect"), n("sect", n("head", t("hi")))), 1, 2, n("doc", n("sect", n("head")), n("sect", n("head", t("hioo")), n("para", t("bar"))))));
        it("adds a caption to a figure", repl(n("doc"), 0, 0, n("doc", n("figure", n("figureimage"))), 1, 0, n("doc", n("figure", n("caption"), n("figureimage")))));
        it("adds an image to a figure", repl(n("doc"), 0, 0, n("doc", n("figure", n("caption"))), 0, 1, n("doc", n("figure", n("caption"), n("figureimage")))));
        it("can join figures", repl(n("doc", n("figure", n("caption"), n("figureimage")), n("figure", n("caption"), n("figureimage"))), 3, 8, null, 0, 0, n("doc", n("figure", n("caption"), n("figureimage")))));
        it("adds necessary nodes to a parent node", repl(n("doc", n("sect", n("head"), n("figure", n("caption"), n("figureimage")))), 7, 9, n("doc", n("para", t("hi"))), 0, 0, n("doc", n("sect", n("head"), n("figure", n("caption"), n("figureimage")), n("para", t("hi"))))));
    });
});
